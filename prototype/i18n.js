...
const I18N = (() => {
  ...
  const UI = {
    ja: {
      ...
      "audio.music": "BGM",
      "audio.sfx": "効果音",
      "audio.note": "BGM は控えめな音量で再生します。スライダーで調整できます。",
      // --- ゲーム画面 ---
      "hint.button": "💡 ヒント",
      ...
      "legend.complete": "完了 ｜ ここで終わり（位置も合わせる）",
      "mark.completeTip": "完了: t={t} でこのストリームは終わる。これ以降は何も流れない。正解と位置が違うと「完了位置ずれ」になる。",
      "mark.errorTip": "エラー終端: t={t} でこのストリームはエラーで終わる。",
      "stream.empty": "(イベントなし)",
    ...
    en: {
      ...
      "audio.music": "Music",
      "audio.sfx": "SFX",
      "audio.note": "Music plays quietly in the background. Use the slider to adjust it.",
      "hint.button": "💡 Hint",
      ...
      "legend.complete": "complete ｜ ends here (match this too)",
      "mark.completeTip": "Complete: the stream ends at t={t} and emits nothing after this. If it does not line up with the goal, you get a \"completion shifted\" mismatch.",
      "mark.errorTip": "Error termination: the stream ends with an error at t={t}.",
      ...
      "node.decrease": "Decrease by 1",
      "node.increase": "Increase by 1",
